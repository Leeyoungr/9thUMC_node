...
router.post("/:missionId", isLogin, validateCreateUserMissionReq, userMissionReqHandler, handleCreateUserMission);

// PATCH /api/v1/missions/:userMissionId -> 사용자 미션 상태 완료 처리
router.patch("/:userMissionId", isLogin, ensureUserMissionExists, userMissionReqHandler, handleCompleteUserMission);
